...
// #define REGISTER_CONVERTER(Type, MetaType)
//     QMetaType::registerConverter<Type, QJsonValue>(&toJson<Type>);
//     // QMetaType::registerConverter<QJsonValue, Type>(fromJson<Type>, QMetaType::QJsonValue, MetaType);

//     REGISTER_CONVERTER(bool, QMetaType::Bool)
//     REGISTER_CONVERTER(int, QMetaType::Int)
//     REGISTER_CONVERTER(double, QMetaType::Double)
//     REGISTER_CONVERTER(uint, QMetaType::UInt)
//     REGISTER_CONVERTER(qint64, QMetaType::LongLong)
//     REGISTER_CONVERTER(quint64, QMetaType::ULongLong)
//     REGISTER_CONVERTER(long, QMetaType::Long)
//     REGISTER_CONVERTER(short, QMetaType::Short)
//     REGISTER_CONVERTER(char, QMetaType::Char)
//     REGISTER_CONVERTER(ulong, QMetaType::ULong)
//     REGISTER_CONVERTER(ushort, QMetaType::UShort)
//     REGISTER_CONVERTER(uchar, QMetaType::UChar)
//     REGISTER_CONVERTER(float, QMetaType::Float)
//     REGISTER_CONVERTER(signed char, QMetaType::SChar)
//     REGISTER_CONVERTER(QChar, QMetaType::QChar)
//     REGISTER_CONVERTER(QString, QMetaType::QString)
//     REGISTER_CONVERTER(QStringList, QMetaType::QStringList)
//     REGISTER_CONVERTER(QByteArray, QMetaType::QByteArray)
//     REGISTER_CONVERTER(QDate, QMetaType::QDate)
//     REGISTER_CONVERTER(QTime, QMetaType::QTime)
//     REGISTER_CONVERTER(QDateTime, QMetaType::QDateTime)
//     REGISTER_CONVERTER(QUrl, QMetaType::QUrl)
//     REGISTER_CONVERTER(QPoint, QMetaType::QPoint)
//     REGISTER_CONVERTER(QPointF, QMetaType::QPointF)
//     REGISTER_CONVERTER(QSize, QMetaType::QSize)
//     REGISTER_CONVERTER(QSizeF, QMetaType::QSizeF)
//     REGISTER_CONVERTER(QRect, QMetaType::QRect)
//     REGISTER_CONVERTER(QRectF, QMetaType::QRectF)
//     REGISTER_CONVERTER(QLine, QMetaType::QLine)
//     REGISTER_CONVERTER(QLineF, QMetaType::QLineF)
//     REGISTER_CONVERTER(QUuid, QMetaType::QUuid)
//     REGISTER_CONVERTER(QColor, QMetaType::QColor)
//     REGISTER_CONVERTER(QPolygon, QMetaType::QPolygon)
//     REGISTER_CONVERTER(QPolygonF, QMetaType::QPolygonF)
//     REGISTER_CONVERTER(QBitArray, QMetaType::QBitArray)
//     REGISTER_CONVERTER(QImage, QMetaType::QImage)
//     REGISTER_CONVERTER(QPixmap, QMetaType::QPixmap)
//     REGISTER_CONVERTER(QIcon, QMetaType::QIcon)
//     REGISTER_CONVERTER(QRegion, QMetaType::QRegion)
//     REGISTER_CONVERTER(QFont, QMetaType::QFont)
//     REGISTER_CONVERTER(QRegularExpression, QMetaType::QRegularExpression)
//     REGISTER_CONVERTER(QByteArrayList, QMetaType::QByteArrayList)
//     REGISTER_CONVERTER(QBrush, QMetaType::QBrush)
//     REGISTER_CONVERTER(QPalette, QMetaType::QPalette)
//     REGISTER_CONVERTER(QPen, QMetaType::QPen)
//     REGISTER_CONVERTER(QPen, QMetaType::QPen)
//     REGISTER_CONVERTER(QBitmap, QMetaType::QBitmap)
//     REGISTER_CONVERTER(QKeySequence, QMetaType::QKeySequence)
//     REGISTER_CONVERTER(QTextFormat, QMetaType::QTextFormat)
//     REGISTER_CONVERTER(QTransform, QMetaType::QTransform)
//     REGISTER_CONVERTER(QColorSpace, QMetaType::QColorSpace)
//     REGISTER_CONVERTER(QEasingCurve, QMetaType::QEasingCurve)
//     // REGISTER_CONVERTER(QStringMap, QMetaType::QStringMap)
// }
